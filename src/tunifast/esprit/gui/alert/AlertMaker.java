 ...
 */
package tunifast.esprit.gui.alert;
...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource(TuniFastUtil.ICON_IMAGE_LOC));
  ...
  private static void styleAlert(Alert alert) {
        ...
        TuniFastUtil.setStageIcon(stage);

        DialogPane dialogPane = alert.getDialogPane();
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/resources/desing.css").toExternalForm());
